...
from lib.models.refinement import StereoDRNetRefinement

from lib.models.feature_extractor import FeatureExtractor
from lib.models.cost import CostVolumePyramid
from lib.models.aggregation import AdaptiveAggregation
from lib.models.estimation import DisparityEstimationPyramid
...
class StereoMatchingNetwork(nn.Module):
    ...
    def forward(self, left_img, right_img):
        ...
        print("Feature shape: ", left_feature.shape)
        ...
        return left_feature, cost_volume, disparity_pyramid
