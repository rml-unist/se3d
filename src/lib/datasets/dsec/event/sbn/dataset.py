...
class EventDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, timestamp):
        ...
        event_data, separated_event = self._post_load_event_data(event_data)

        return event_data, separated_event
    ...
    def _post_load_event_data(self, event_data):
        ...
        for location in self._LOCATION:
            ...
            event_data[location], separated_event[loc] = self.stack_function.post_stack(event_data[location])
