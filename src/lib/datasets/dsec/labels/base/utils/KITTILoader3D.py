...
from utils.kitti_dataset import kitti_dataset as kittidataset
...
def get_kitti_annos(labels,
    ...
    for i, label in enumerate(labels):
        # 4 will be ignored.
        if label.type == 'Pedestrian' or label.type == 'Person_sitting': typ = 2
        elif label.type == 'Car' or label.type == 'Van': typ = 1
